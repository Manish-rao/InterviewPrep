...
public class Container {
    ...
    public <T> T resolve(Class<T> type) throws IoCException {
        ...
        List<com.CustomContainer.Constructor> constructorParams = registration.getConstructorParams();
        T instance;
        try {
    ...
    private void getNonReferenceParameters(List<com.CustomContainer.Constructor> constructorParams, List<Object> parameterInstances, Parameter parameter, Class parameterClass) {
        Object value = null;
        for (com.CustomContainer.Constructor ctor : constructorParams) {
